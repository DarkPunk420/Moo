...
// Netscape format cookie file found in same location as executable
const (
...
// Parses cookie file and create jar
func ImportCookies(filename string) (*cookiejar.Jar, error) {
	...
	for scanner.Scan() {
		...
		if err != nil {
			continue // Skip lines with invalid URLs
		}
